...
MODEL                = EPS_MILS
MODULES              = EPS_MILS.c EPS_MILS_capi.c EPS_MILS_data.c EPS_MILS_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = EPS_MILS.exe
MAKEFILE             = EPS_MILS.mk
MATLAB_ROOT          = C:/Program Files/MATLAB/R2023a
ALT_MATLAB_ROOT      = C:/PROGRA~1/MATLAB/R2023a
START_DIR            = C:/Users/Ameya/Documents/IITBSSP/EPS/CubeSat-Power_Github/CubeSat-Power
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = EPS_MILS_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/EPS_MILS \
